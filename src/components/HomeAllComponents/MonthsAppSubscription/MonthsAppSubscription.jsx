  ...
  return (
    <div>
      <div className="container">
        <h2 className="text-3xl font-bold leading-[32px] text-secondary text-center pt-2 pb-10">
          2 Months App Subscription for the price of one driving lesson!
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="md:col-span-1">
            ...
            />
            <h3 className="text-[27px] font-medium text-secondary leading-[29px] text-center py-8">Save money on lessons!</h3>
          ...
          <Image
              ...
              className="w-full h-[320px]"
            />
            <h3 className="text-[27px] font-medium text-secondary leading-[29px] text-center py-8">Pass with Route-Led!</h3>
        ...
        <p className="text-base text-secondary font-thin leading-[20px] text-center py-6">For more information about our driving test routes app check out the website <Link className="text-primary underline cursor-pointer" href='/'>www.drivingtestroutesapp.co.uk</Link></p>
        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-10 py-5">
